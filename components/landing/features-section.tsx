...
import { KeyboardIcon, Layers, Layout, Zap } from "lucide-react";
import { motion } from "framer-motion"
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "../ui/card";

const FEATURES = [
  {
    icon: <Layout className="size-6 text-primary mb-2" />,
    title: "Smart Metadata",
    desc: "Automatically extracts titles, descriptions, and high-quality favicons from any link you save."
  },
  {
    icon: <Layers className="size-6 text-primary mb-2" />,
  ...
  {
    icon: <Zap className="size-6 text-primary mb-2" />,
    title: "Lightning Fast",
    desc: "Built on a modern stack to ensure your dashboard loads instantly, with real-time syncing across devices."
  },
  {
    icon: <KeyboardIcon className="size-6 text-primary mb-2" />,
    title: "Keyboard Shortcuts",
    desc: "Use keyboard to navigate bookmarks from dashboard. No need to use hands across multiple accessories at once."
  },
]
    ...
    >
      <div className="text-center mb-16">
        ...
        <p className="text-muted-foreground mt-4 text-lg">
          Designed for maximum focus and effortless organization.
        </p>
      </div>
